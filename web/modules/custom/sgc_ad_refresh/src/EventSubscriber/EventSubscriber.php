...
class EventSubscriber implements EventSubscriberInterface {
  ...
  public function onResponse(ResponseEvent $event) {
    ...
    if ($event->isMainRequest()) {
      ...
      /**
       * Ternary operator provides a layer of defense.  Could use error/excepption handling with try/catch.
       */
      ...
      if (!empty($status) && $status == 1) {
        ...
        /**
         * Security/Performance concern: avoids attaching JavaScript if the page is excluded from the module and the response is not an AttachmentsInterface.
         */
