...
class TagViewTest extends UnitTestCase {
  ...
  public function testFormatSize($size, $expected) {
    // TagView::formatSize() returns a \Drupal\Component\Render\MarkupInterface
    // object.
    $this->assertSame($expected, (string) TagView::formatSize($size));
  }

  /**
   * Data provider for self::testFormatSize().
   */
  public static function formatSizeProvider() {
    return [
      ['<none>', '[]'],
      ['invalid-size1x1', '[]'],
      ['300x250invalid-size', '[]'],
      ['fluid', '["fluid"]'],
      ['300x250 ', '[300, 250]'],
      ['300x250, 300x250invalid-size', '[300, 250]'],
      ['300x250, 728x90 ', '[[300, 250], [728, 90]]'],
      ['300x250, 728x90, fluid', '[[300, 250], [728, 90], "fluid"]'],
      ["300x250,alert('hi'),fluid", '[[300, 250], "fluid"]'],
    ];
  }
   ...
   */
  public static function getSlugProvider() {
    return [
   ...
   */
  public static function getAdUnitProvider() {
    return [
   ...
   */
  public static function getShortTagQueryStringProvider() {
    return [
      [
        'adunit',
        '300x200',
